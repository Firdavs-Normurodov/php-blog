...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['PUT'])) {
  ...
  $statment = $pdo->prepare("UPDATE posts SET title =:title, body=:body WHERE id=:id");
  $statment->execute([
    'title' => $title,
    'body' => $body,
    'id'=>$id,
  ]);
  $_SESSION['success']='Post muvaffaqqiyatli o\'zgartirildi';
  ...
  <div class="row">
    <header class="pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
        ...
        <span class="fs-4">Postni o'zgartiring</span>
      </a>
    </header>
